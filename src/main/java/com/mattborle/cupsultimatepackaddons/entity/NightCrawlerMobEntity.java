...
public class NightCrawlerMobEntity extends Monster {
    ...
    public SoundEvent getAmbientSound() {
        return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("cupsultimatepackaddons:night_crawler_ambient"));
    }
    ...
    public SoundEvent getHurtSound(DamageSource ds) {
        return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("cupsultimatepackaddons:night_crawler_hurt"));
    }

    @Override
    public SoundEvent getDeathSound() {
        return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("cupsultimatepackaddons:night_crawler_death"));
    }
