...
import com.mattborle.cupsaddons.client.renderer.item.DistinguishedPickaxeRenderer;
import com.mattborle.cupsaddons.client.renderer.item.MastersPickaxeRenderer;
...
public class MastersPickaxeItem extends PickaxeItem implements IAnimatable {
    ...
    public MastersPickaxeItem(Tier tier, int p_42962_, float p_42963_, Properties properties) {
        super(tier, p_42962_, p_42963_, properties
                .tab(ItemRegistry.CreativeTab.instance)     // Show in creative menu tab
                .rarity(Rarity.RARE)                        // Rarity color for title and loot beams
    ...
    public void initializeClient(Consumer<IItemRenderProperties> consumer) {
        ...
        consumer.accept(new IItemRenderProperties() {
            private final BlockEntityWithoutLevelRenderer renderer = new MastersPickaxeRenderer();
