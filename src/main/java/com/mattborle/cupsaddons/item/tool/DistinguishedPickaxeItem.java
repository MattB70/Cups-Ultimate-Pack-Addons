...
public class DistinguishedPickaxeItem extends PickaxeItem implements IAnimatable {
    ...
    public DistinguishedPickaxeItem(Tier tier, int p_42962_, float p_42963_, Properties properties) {
    ...
    public void initializeClient(Consumer<IItemRenderProperties> consumer) {
        ...
        consumer.accept(new IItemRenderProperties() {
            private final BlockEntityWithoutLevelRenderer renderer = new DistinguishedPickaxeRenderer();
