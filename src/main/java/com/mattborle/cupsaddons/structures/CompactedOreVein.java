package com.mattborle.cupsaddons.structures;
...
public class CompactedOreVein extends StructureFeature<JigsawConfiguration> {
    ...
    public CompactedOreVein() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, CompactedOreVein::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        // Checks to make sure our structure does not spawn within 10 chunks of an Ocean Monument, placeholder at best.
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!CompactedOreVein.isFeatureChunk(context)) {
