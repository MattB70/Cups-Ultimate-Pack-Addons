...
import com.mattborle.cupsaddons.effect.*;
...
public class MobEffectRegistry {
    // Registry
    public static final DeferredRegister<MobEffect> MOD_EFFECTS = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, CupsAddons.MOD_ID);
